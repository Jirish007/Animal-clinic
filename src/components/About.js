...
return(
  ...
  <h2>Why Us?</h2>
   ...
   <img src={imageAbout}></img>
    <p>At Happy Pets Clinic, we are dedicated to providing exceptional veterinary care to the beloved pets of our community. Our state-of-the-art facility is equipped with the latest technology and staffed by a team of compassionate and experienced veterinary professionals.</p>
  <br></br>
  ...
  <br></br>
  <p>Our veterinary team is led by Girish Tibatina, a highly respected and experienced veterinarian with a passion for delivering exceptional care. Our support staff is equally dedicated, with a collective goal of providing outstanding customer service and ensuring that every visit to our clinic is a positive and stress-free experience.</p>
  <br></br>
  <p>At Happy Pets Clinic, we believe in staying at the forefront of veterinary medicine, and we regularly attend continuing education seminars and workshops to ensure that we are always up-to-date on the latest treatments and technologies.</p>
  <br></br>
